# 🔬 MyLesion — AI Skin Condition Analyzer
...
1. Open [`colab/MyLesion_Training.ipynb`](colab/MyLesion_Training.ipynb) in [Google Colab](https://colab.research.google.com)
2. Set Runtime → **T4 GPU**
3. Run all cells — follow the prompts to upload your `kaggle.json`
4. The notebook downloads `mylesion.keras` at the end
5. Place it at `backend/model/mylesion.keras`
...
│   ├── model/
│   │   └── mylesion.keras ← Trained model (from Colab — not committed)
│   └── .env.example        ← API key template
├── colab/
│   └── MyLesion_Training.ipynb  ← Full training notebook
├── requirements.txt
└── README.md
```
...
MyLesion is an **experimental AI tool** built for educational and research purposes. It is **not a medical device** and does not provide medical diagnoses. Always consult a qualified dermatologist or healthcare professional for any skin concerns.
